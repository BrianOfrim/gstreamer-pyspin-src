# NOTE: THIS DOES NOT WORK. WAITING FOR PYTHON SUPPORT FOR DEEPSTREAM OBJECT FLOW
...
def on_new_sample(sink, appsrc, user_function):
    ...
    if result:
        ...
        if frame_meta is not None:
            ...
            for fmeta_list in frame_meta.frame_meta_list:
                of_user_meta = pyds.NvDsUserMata(fmeta_list.data)
                if of_user_meta is not None and of_user_meta.meta_type == pyds.NVDS_OPTICAL_FLOW_META:
                    ofmeta = pyds.NvDsOpticalFlowMeta
